...
export const CLI_COMMANDS: CliCommandEntry[] = [
  ...
  },
  {
    name: "skills",
    aliases: ["skill"],
    usage: "ocx skills <list|view|create|edit|toggle|delete|sync|trash|restore> ...",
    summary: "Manage centralized skills store and cross-agent symlinks.",
    details: [
      "list [options]       List skills across central store (~/.agents/skills) and agent symlinks.",
      "view <name>          Inspect skill metadata and markdown content.",
      "create <name>        Create a new skill in central store and link to agents.",
      "edit <name>          Update skill metadata or markdown content.",
      "toggle <name>        Enable or disable a skill globally or per agent.",
      "delete <name> --yes  Safely delete a skill (moves to trash store).",
      "sync                 Deduplicate physical skills, migrate to central store, and link agents.",
      "trash                List deleted skills in trash.",
      "restore <trash-id>   Restore a deleted skill from trash.",
    ],
  },
  {
    name: "skill",
    aliases: [],
    usage: "ocx skill <subcommand>",
    summary: "Alias of ocx skills.",
  },
  {
    name: "mcp",
    usage: "ocx mcp <list|get|add|edit|toggle|delete|clone> ...",
    summary: "Manage multi-client MCP servers (Claude Desktop/Code, Codex, Antigravity).",
    details: [
      "list                 List configured MCP servers across all clients.",
      "get <id> --client    Inspect MCP server configuration.",
      "add <id> --client    Add a new MCP server (command, args, env, url).",
      "edit <id> --client   Update existing MCP server configuration.",
      "toggle <id> --client Enable or disable an MCP server.",
      "delete <id> --client Delete an MCP server from client config.",
      "clone <id> --from --to Cross-client MCP server cloning and sharing.",
    ],
  },
  {
    name: "sessions",
    aliases: ["session"],
    usage: "ocx sessions <list|view|handoff> ...",
    summary: "Manage cross-agent sessions (Codex, AGY, Claude Code) and trigger handoffs.",
    details: [
      "list [options]       List sessions across discovered agents.",
      "view <agent> <id>    Inspect detailed session turns and touched files.",
      "handoff <agent> <id> --to <target> Generate handoff context and dispatch execution.",
    ],
  },
  {
    name: "session",
    aliases: [],
    usage: "ocx session <subcommand>",
