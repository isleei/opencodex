...
export const CLI_COMMANDS: CliCommandEntry[] = [
  ...
  {
    name: "export",
    usage: "ocx export --client <opencode|pi|omp|hermes|openclaw|kimi|gajae|dsh|mcode|zcode|prime|cline|aside|raycast> [--json] [--out <path>] [--force]",
    summary: "Print a client config (OpenCode, Pi, OMP, Hermes, OpenClaw, Kimi Code, Gajae Code, DeepSeek Harness, MiniMax Code, ZCode, Prime Agent, Cline, Aside, Raycast) wired to the running proxy.",
    details: [
  ...
  {
    name: "agy",
    usage: "ocx agy [agy args...] | ocx agy <accounts|use|switch|hook>",
    summary: "Launch Antigravity CLI (agy) with account selection, proxy readiness, and usage tracking.",
    details: [
      "Launch options:",
      "  ocx agy [args...]                    Launch agy (interactive account picker if multiple)",
      "  ocx agy --account <id|email|index>   Launch agy with specified Google Antigravity account",
      "  ocx agy -a <id|email|index>          Alias of --account",
      "  ocx agy --no-select                  Launch using current active account without prompt",
      "",
      "Management subcommands:",
      "  ocx agy accounts [--json]            List configured Google Antigravity accounts",
      ...
      "  ocx agy hook <install|uninstall>     Manage the AGY token usage ingestion hook",
    ],
  },
  {
    name: "restart",
