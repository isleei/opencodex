...
import { clearModelCache, DEFAULT_MODEL_CACHE_TTL_MS, getProviderDiscoveryStatus, getProviderLiveModelCount } from "../../codex/model-cache";
...
export async function handleProviderRoutes(ctx: ManagementContext): Promise<Response | null> {
  ...
  if (url.pathname === LOCAL_PROVIDER_RELOAD_PATH && req.method === "POST") {
    ...
    const allowBenchmarkAddresses = true;
