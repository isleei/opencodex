...
const EXPECTED_KEY_PROVIDER_IDS = [
  "anthropic-apikey", "openai-apikey", "meta-model", "umans", "opencode-go", "neuralwatt", "openrouter", "cline-pass", "cline-apikey", "orcarouter", "packycode", "bizrouter", "groq", "google", "google-vertex", "azure-openai",
...
describe("provider registry parity", () => {
  ...
  test("GUI preset projection preserves current featured set plus key catalog and custom", () => {
    ...
    expect(featured).toEqual([
      "openai", "xai", "command-code", "orcarouter-oauth", "anthropic", "anthropic-apikey", "kimi", "nous", "openai-apikey", "umans", "opencode-go", "openrouter", "cline",
