...
const EXPECTED_KEY_PROVIDER_IDS = [
  "anthropic-apikey", "openai-apikey", "umans", "opencode-go", "neuralwatt", "openrouter", "cline-pass", "cline-apikey", "orcarouter", "bizrouter", "groq", "google", "google-vertex", "azure-openai",
