...
describe("EXPORT_CLIENTS registry", () => {
  test("covers exactly the file-toggle clients", () => {
    expect(EXPORT_CLIENT_IDS).toEqual(["opencode", "pi", "omp", "hermes", "openclaw", "kimi", "gajae", "dsh", "mcode", "zcode", "prime", "cline", "aside"]);
