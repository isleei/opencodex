...
describe("opencodex config defaults", () => {
  ...
  test("recognizes opencodex start command lines", () => {
    ...
    expect(isOcxStartCommandLine('bun C:/tools/bun/install/global/node_modules/@iislee/opencodex/src/cli.ts start')).toBe(true);
    ...
    expect(isOcxStartCommandLine(
      'bun C:/nvm/node_modules/@iislee/.opencodex-1JejBqbZ/src/cli/index.ts start --port 10100',
    )).toBe(true);
