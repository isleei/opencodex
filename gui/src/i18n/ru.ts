...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.cacheWarning": "После любой смены аккаунта OpenCodex воспроизводит контекст разговора, но кэш промптов на стороне провайдера может быть холодным.",
