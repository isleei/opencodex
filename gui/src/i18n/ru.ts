...
export const ru: Record<TKey, string> = {
  ...
  "api.clientConfig.clientLabel": "Клиент",
  ...
  "api.attribution.railRequests": "{count} зап./7 дн.",
  "api.attribution.railLastUsed": "исп. {date}",
  "api.attribution.railNeverUsed": "не использовался",
