...
"common.discard": "Discard",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "usage.search.accounts": "Search accounts…",
  ...
  "usage.account.filteredNotice": "Per-account totals are not reported under a provider or model filter. Run without filters for per-account spend.",
  "usage.account.ambiguous": "ambiguous",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "integrations.semantics.cline": "Manages only providers.opencodex in Cline's providers.json. Your other providers and settings stay unchanged. Applies to new sessions.",
  ...
  "grok.subtitle": "xAI account quota and Grok Build model wiring.",
  ...
  "sessions.view.flat": "Timeline",
  "sessions.view.grouped": "Group by Project",
  "sessions.filter.all": "All Agents",
  "sessions.filter.all_projects": "All Projects",
  "sessions.project.sessions_count": "{count} sessions",
  "sessions.search.placeholder": "Search session prompt, id, files...",
  "sessions.loading": "Scanning agent sessions on disk...",
  "sessions.empty.title": "No Agent Sessions Found",
  "sessions.empty.desc": "Run tasks in OpenAI Codex, Antigravity (AGY), Claude Code, or Grok Build to see active sessions appear here.",
  "workflows.workspace": "Project directory (absolute path on the server)",
  "workflows.requirements": "Full requirements",
  "workflows.agent": "Execution tool",
  "workflows.rejectionNote": "Reason for rejection / requested fixes",
  "workflows.baseRevision": "Review base revision (optional; defaults to HEAD at run creation)",
  "workflows.monitor.subtitle": "Track progress and review results here. Start tasks in your Codex conversation.",
  "workflows.monitor.title": "Start in Codex",
  "workflows.monitor.hint": "Describe the task in the project conversation. Codex records the workflow; this page shows progress and approval requests.",
  "workflows.monitor.example": "Use ocx-workflow for this project: you plan, OpenCode implements, then you review. Wait for my approval after the plan. Task: [describe the change and acceptance criteria].",
  "workflows.monitor.copy": "Copy prompt",
  "workflows.monitor.history": "Show finished tasks ({count})",
  "workflows.monitor.empty": "No active tasks. Start a workflow in your Codex project conversation.",
  "workflows.monitor.feature": "Plan → implement → review",
  "workflows.monitor.audit": "Independent code review",
  "workflows.monitor.debug": "Investigate → fix → verify",
  "workflows.monitor.executing": "The workflow is executing. Phase results will appear here.",
  "workflows.monitor.resumeHint": "Return to the original Codex conversation to continue. Approving here does not wake that conversation automatically.",
  "workflows.monitor.resume": "Continue ocx-workflow run {id}. Read its saved state and resume the current phase; wait at any pending approval gate.",
  "workflows.templates.title": "Choose a template",
  "workflows.templates.create": "Save as my template",
  "workflows.templates.hint": "Select a saved template, then describe the task in Codex. Tool and model settings are reused.",
  "workflows.templates.personal": "Personal template",
  "workflows.templates.planner": "Plan",
  "workflows.templates.worker": "Implement",
  "workflows.templates.reviewer": "Review",
  "workflows.templates.api": "OpenCodex API",
  "workflows.templates.unset": "Model not configured",
  "workflows.templates.conversationHint": "Planning and review happen in this Codex conversation. Worker tools and models come from the template; configure any missing worker model once.",
  "workflows.templates.configure": "Configure template",
  "workflows.templates.prompt": "Use ocx-workflow template \"{id}\" for this project. Follow its saved phases, worker tools, models and approval gates. You handle planning and review in this conversation. Task: [requirements and acceptance criteria].",
  "workflows.templates.roleTool": "Tool for {role}",
  "workflows.templates.perPhase": "Configured per phase",
  "workflows.templates.conversation": "Current Codex conversation",
  "workflows.title": "Workflows",
  "workflows.subtitle": "Codex-led, phase-sequenced model runs: plan with one model, implement with another, review before it lands.",
  "workflows.refresh": "Refresh",
  "workflows.newRun": "New Run",
  "workflows.runs": "Runs",
  "workflows.empty": "No workflow runs yet. Start one with \"New Run\".",
  "workflows.definitions": "Definitions",
  "workflows.builtin": "built-in",
  "workflows.phaseProgress": "phase {index}/{total}",
  "workflows.status.awaiting": "awaiting gate: {gate}",
  "workflows.status.running": "running",
  "workflows.status.completed": "completed",
  "workflows.status.aborted": "aborted",
  "workflows.start.title": "Start a workflow run",
  "workflows.start.workflow": "Workflow",
  "workflows.start.titleField": "Title",
  "workflows.start.roleModel": "Model for role \"{role}\"",
  "workflows.start.auto": "Execute phases automatically until the next gate",
  "workflows.start.submit": "Start run",
  "workflows.startAutoNotice": "Run started — executing until the next gate",
  "workflows.startNotice": "Run started",
  "workflows.runSaved": "Workflow \"{id}\" saved",
  "workflows.runDeleted": "Workflow \"{id}\" deleted",
  "workflows.deleteConfirm": "Delete user workflow \"{id}\"? Runs already in progress are unaffected.",
  "workflows.copied": "Copied",
  "workflows.copyStatus": "Copy status",
  "workflows.close": "Close",
  "workflows.journal": "Journal",
  "workflows.gateWaiting": "Waiting at gate: {gate}",
  "workflows.gateApprove": "Approve",
  "workflows.gateReject": "Reject",
  "workflows.executePhase": "Execute phase",
  "workflows.advance": "Advance",
  "workflows.abort": "Abort",
  "workflows.outputsPlaceholder": "Outputs to record for the current phase (optional)…",
  "workflows.notice.advanced": "Advanced",
  "workflows.notice.gateApproved": "Gate approved",
  "workflows.notice.gateRejected": "Gate rejected — sent back for rework",
  "workflows.notice.aborted": "Run aborted",
  "workflows.notice.alreadyExecuting": "Already executing",
  "workflows.notice.executeStarted": "Phase execution started",
  "workflows.editor.customize": "Customize \"{id}\"",
  "workflows.editor.edit": "Edit workflow",
  "workflows.editor.new": "New workflow",
  "workflows.editor.overrideNote": "Saving stores a user definition with the same id — it overrides the built-in. Delete it later to restore the built-in.",
  "workflows.editor.id": "Workflow id",
  "workflows.editor.title": "Title",
  "workflows.editor.description": "Description",
  "workflows.editor.defaults": "Default models (role → model ref)",
  "workflows.editor.defaultsPlaceholder": "provider/model | combo/id | policy/id",
  "workflows.editor.noRoles": "No roles yet — use model refs like role:planner in a phase to create one.",
  "workflows.editor.phases": "Phases (top runs first)",
  "workflows.editor.phaseIdPlaceholder": "phase-id",
  "workflows.editor.modelRefPlaceholder": "modelRef (role:planner or provider/model)",
  "workflows.editor.gateIdPlaceholder": "gate-id",
  "workflows.editor.promptPlaceholder": "Prompt for this phase…",
  "workflows.editor.inputsPlaceholder": "Inputs from earlier phases, comma separated (e.g. plan, diff)",
  "workflows.editor.rejectNearest": "reject → nearest previous work phase",
  "workflows.editor.rejectTo": "reject → {phase}",
  "workflows.editor.addPhase": "+ Work phase",
  "workflows.editor.addGate": "+ Gate",
  "workflows.editor.cancel": "Cancel",
  "workflows.editor.save": "Save workflow",
  "workflows.editor.saving": "Saving…",
  "workflows.editor.errId": "Workflow id must be alphanumeric (.-_ allowed).",
  "workflows.editor.errPhaseRequired": "At least one phase is required.",
  "workflows.editor.errPhaseId": "Invalid phase id: {id}",
  "workflows.editor.errDuplicate": "Duplicate phase id: {id}",
  "workflows.editor.errFirstGate": "The first phase must not be a gate.",
  "workflows.go.placeholder": "Describe what you want — e.g. add rate limiting to the login API",
  "workflows.go.button": "Go",
  "workflows.go.hint": "One step: the engine picks the workflow, uses your default model, and stops at the approval gate.",
  "workflows.go.started": "Started — it will stop at the approval gate",
  "sessions.action.inspect": "Inspect",
  "sessions.action.handoff": "Handoff",
  "sessions.handoff.title": "Cross-Agent Session Handoff",
  "sessions.handoff.strategy": "Handoff Strategy",
  "sessions.handoff.custom": "Additional Instructions (Optional)",
  "skillsMcp.subtitle": "Centralized skills repository and multi-client MCP server configuration.",
  "skillsMcp.tabsLabel": "Skills and MCP management tabs",
  "skillsMcp.tab.skills": "Skills",
  "skillsMcp.tab.mcp": "MCP Servers",
  "skillsMcp.skills.searchPlaceholder": "Search skills by name, description, tags, author, content…",
  "skillsMcp.skills.filterStatusLabel": "Filter by status",
  "skillsMcp.skills.filterStatusAll": "All status",
  "skillsMcp.skills.filterStatusActive": "Active",
  "skillsMcp.skills.filterStatusDisabled": "Disabled",
  "skillsMcp.skills.filterAgentLabel": "Filter by agent",
  "skillsMcp.skills.filterAgentAll": "All agents",
  "skillsMcp.skills.filterTagLabel": "Filter by tag",
  "skillsMcp.skills.filterTagAll": "All tags",
  "skillsMcp.skills.syncAllBtn": "Sync All Symlinks",
  "skillsMcp.skills.syncing": "Syncing…",
  "skillsMcp.skills.syncSuccess": "Successfully synchronized {synced} symlinks ({migrated} migrated, {deduped} deduplicated).",
  "skillsMcp.skills.trashBtn": "Trash / Recovery",
  "skillsMcp.skills.newSkillBtn": "New Skill",
  "skillsMcp.skills.emptyTitle": "No skills installed",
  "skillsMcp.skills.emptyFilteredTitle": "No skills match the selected filters",
  "skillsMcp.skills.resetFiltersBtn": "Reset filters",
  "skillsMcp.skills.colActive": "Active",
  "skillsMcp.skills.colName": "Skill Name",
  "skillsMcp.skills.colDescription": "Description",
  "skillsMcp.skills.colTags": "Tags",
  "skillsMcp.skills.colLinkedAgents": "Linked Agents",
  "skillsMcp.skills.colStorage": "Storage",
  "skillsMcp.skills.colActions": "Actions",
  "skillsMcp.skills.toggleAria": "Toggle skill {name}",
  "skillsMcp.skills.editBtn": "Edit skill",
  "skillsMcp.skills.badgeSystem": "system",
  "skillsMcp.skills.byAuthor": "by {author}",
  "skillsMcp.skills.filterByTag": "Filter by #{tag}",
  "skillsMcp.skills.noAgentsLinked": "None linked",
  "skillsMcp.skills.storageSymlinked": "Symlinked",
  "skillsMcp.skills.storageCentral": "Central",
  "skillsMcp.skills.createSuccess": "Skill '{name}' created successfully.",
  "skillsMcp.skills.updateSuccess": "Skill '{name}' updated successfully.",
  "skillsMcp.skills.deleteSuccess": "Skill '{name}' moved to trash.",
  "skillsMcp.skills.modal.createTitle": "Create New Skill",
  "skillsMcp.skills.modal.editTitle": "Edit Skill: {name}",
  "skillsMcp.skills.modal.viewEditOnly": "Editor only",
  "skillsMcp.skills.modal.viewSplit": "Split view",
  "skillsMcp.skills.modal.viewPreviewOnly": "Preview only",
  "skillsMcp.skills.modal.tabEdit": "Edit",
  "skillsMcp.skills.modal.tabSplit": "Split",
  "skillsMcp.skills.modal.tabPreview": "Preview",
  "skillsMcp.skills.modal.deleteConfirmTitle": "Delete this skill?",
  "skillsMcp.skills.modal.deleteConfirmBody": "Moving '{name}' to trash will remove symlinks across all linked agents. You can restore it later from Trash / Recovery.",
  "skillsMcp.skills.modal.fieldName": "Skill Name (directory identifier)",
  "skillsMcp.skills.modal.placeholderName": "e.g. git-workflow, code-reviewer",
  "skillsMcp.skills.modal.fieldVersion": "Version",
  "skillsMcp.skills.modal.fieldAuthor": "Author / Team",
  "skillsMcp.skills.modal.placeholderAuthor": "e.g. OpenCodex Community",
  "skillsMcp.skills.modal.fieldTags": "Tags (comma-separated)",
  "skillsMcp.skills.modal.fieldDescription": "Description & Trigger Intent",
  "skillsMcp.skills.modal.placeholderDescription": "Brief explanation of what the skill does and triggering keywords…",
  "skillsMcp.skills.modal.fieldActive": "Enabled / Active",
  "skillsMcp.skills.modal.sourceHeader": "Source Markdown",
  "skillsMcp.skills.modal.previewHeader": "Live Preview",
  "skillsMcp.skills.modal.placeholderContent": "Write skill markdown content here with instructions, examples, and rules…",
  "skillsMcp.skills.modal.errorNameRequired": "Skill name is required.",
  "skillsMcp.skills.modal.errorNameInvalid": "Skill name must only contain lowercase letters, numbers, hyphens, and underscores.",
  "skillsMcp.skills.trash.modalTitle": "Skills Trash & Recovery",
  "skillsMcp.skills.trash.modalSubtitle": "Deleted skills are safely retained here. Restoring a skill recreates symlinks for all linked agents.",
  "skillsMcp.skills.trash.emptyTitle": "Trash is empty",
  "skillsMcp.skills.trash.emptyBody": "No deleted skills found in trash storage.",
  "skillsMcp.skills.trash.colSkill": "Skill Name",
  "skillsMcp.skills.trash.colDeletedAt": "Deleted At",
  "skillsMcp.skills.trash.colOriginalPath": "Original Path",
  "skillsMcp.skills.trash.colAction": "Action",
  "skillsMcp.skills.trash.restoreBtn": "Restore",
  "skillsMcp.skills.trash.restoring": "Restoring…",
  "skillsMcp.skills.trash.restoreSuccess": "Skill '{name}' restored and symlinks re-established.",
  "skillsMcp.mcp.searchPlaceholder": "Search MCP servers by ID, command, args, environment, URL…",
  "skillsMcp.mcp.showSecrets": "Show secrets",
  "skillsMcp.mcp.maskSecrets": "Mask secrets",
  "skillsMcp.mcp.addServerBtn": "Add MCP Server",
  "skillsMcp.mcp.emptyFilteredTitle": "No MCP servers match the search query",
  ...
  "skillsMcp.mcp.serverCount": "{count} servers",
  "skillsMcp.mcp.addServerToClient": "Add server to {client}",
  "skillsMcp.mcp.noServersConfigured": "No MCP servers configured for this client.",
  "skillsMcp.mcp.toggleAria": "Toggle server {id}",
  "skillsMcp.mcp.scopeProject": "project",
  "skillsMcp.mcp.editBtn": "Edit server",
  "skillsMcp.mcp.cloneBtn": "Clone to other client",
  "skillsMcp.mcp.addSuccess": "MCP server '{id}' added successfully.",
  "skillsMcp.mcp.updateSuccess": "MCP server '{id}' updated successfully.",
  "skillsMcp.mcp.deleteSuccess": "MCP server '{id}' deleted successfully.",
  "skillsMcp.mcp.cloneSuccess": "MCP server '{id}' cloned to {target}.",
  "skillsMcp.mcp.modal.createTitle": "Add MCP Server",
  "skillsMcp.mcp.modal.editTitle": "Edit MCP Server: {id}",
  "skillsMcp.mcp.modal.fieldClient": "Client Target",
  "skillsMcp.mcp.modal.fieldTransport": "Transport Protocol",
  "skillsMcp.mcp.modal.fieldServerId": "Server Identifier (ID)",
  "skillsMcp.mcp.modal.placeholderServerId": "e.g. memory, sqlite, context7",
  "skillsMcp.mcp.modal.fieldCommand": "Command Executable",
  "skillsMcp.mcp.modal.fieldArgs": "Arguments",
  "skillsMcp.mcp.modal.fieldCwd": "Working Directory (optional)",
  "skillsMcp.mcp.modal.fieldUrl": "Remote Server URL (SSE / HTTP)",
  "skillsMcp.mcp.modal.fieldEnabled": "Server Enabled",
  "skillsMcp.mcp.modal.envHeader": "Environment Variables",
  "skillsMcp.mcp.modal.addEnvVar": "Add Variable",
  "skillsMcp.mcp.modal.envEmptyNote": "No environment variables configured.",
  "skillsMcp.mcp.modal.errorIdRequired": "Server ID is required.",
  "skillsMcp.mcp.modal.errorCommandRequired": "Command executable is required for stdio transport.",
  "skillsMcp.mcp.modal.errorUrlRequired": "Remote server URL is required for SSE transport.",
  "skillsMcp.mcp.clone.modalTitle": "Clone MCP Server",
  "skillsMcp.mcp.clone.modalSubtitle": "Copy MCP server '{id}' from {client} to another coding client with automatic format translation.",
  "skillsMcp.mcp.clone.sourceLabel": "Source Server",
  "skillsMcp.mcp.clone.targetClientLabel": "Target Client",
  "skillsMcp.mcp.clone.newIdLabel": "Target Server ID",
  "skillsMcp.mcp.clone.overwriteLabel": "Overwrite target configuration if server ID already exists",
  "skillsMcp.mcp.clone.cloneBtn": "Clone Server",
  ...
  "subscriptions.agy.syncPanelTitle": "AGY sync state (this proxy host)",
  "subscriptions.agy.rowProxy": "Proxy active account: {account}",
  "subscriptions.agy.rowCli": "CLI credentials: {status}",
  "subscriptions.agy.rowIde": "IDE sync: {status}",
  "subscriptions.agy.status.synced": "synced",
  "subscriptions.agy.status.pending_restart": "pending — quit IDE normally, then retry",
  "subscriptions.agy.status.failed": "failed",
  "subscriptions.agy.status.unsupported": "unsupported",
  "subscriptions.agy.status.not_installed": "not installed",
  "subscriptions.agy.status.unknown": "unknown",
  "subscriptions.agy.retrySync": "Retry sync for current account",
  "subscriptions.agy.proxyHostNote": "Sync applies to the machine running this proxy, not necessarily the browser's machine. CLI takes effect for agy processes started after the switch.",
  "subscriptions.agy.nativeKeyringNote": "Note: on macOS the OS keychain entry is written and read back as part of the switch; on other platforms only the CLI files are synced.",
  "subscriptions.agy.switchPartial": "{target} sync needs attention: {detail}",
  "subscriptions.agy.switchUnknown": "Switch outcome unknown: {detail}. State was refreshed — check the sync panel and retry if needed.",
  "subscriptions.agy.cliOnlyNoIde": "Switched to {account}. CLI synced; Antigravity IDE is not installed on this host.",
  "subscriptions.agy.noActiveAccount": "none",
  "subscriptions.agy.quota.gemini": "Gemini",
  "subscriptions.agy.quota.claudeGpt": "Claude / GPT",
  "subscriptions.agy.quota.weekly": "Weekly",
  "subscriptions.agy.quota.fiveHour": "5-hour",
  "subscriptions.agy.quota.stale": "Cached reading — out of date",
  "subscriptions.agy.quota.updating": "Updating quota…",
  "subscriptions.agy.quota.staleRetry": "Refresh failed; showing the last successful reading. Retrying in 30 seconds.",
  "subscriptions.agy.quota.scopeNote": "Shared subscription limits per group: weekly and 5-hour windows.",
  "subscriptions.agy.quota.unknown": "Quota unknown",
  "subscriptions.agy.quota.unavailable": "Quota unavailable",
  "subscriptions.agy.quota.unavailableHint": "Last probe failed; showing no cached reading as current.",
  "subscriptions.agy.quota.remaining": "{pct}% remaining",
  "subscriptions.agy.quota.resetUnknown": "Reset unknown",
  "subscriptions.agy.quota.observedLabel": "Observed",
  "subscriptions.agy.quota.observedAt": "Observed {time}",
  "subscriptions.agy.quota.observedUnknown": "Observation time unknown",
