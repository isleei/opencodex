...
export const en = {
  ...
  "dash.injectionHint": "Choose the model and optional effort shared by the two controls below.",
  "dash.syncCodexSubagentDefaults": "Use as native Codex subagent defaults",
  "dash.syncCodexSubagentDefaultsHint": "Off by default. When OpenCodex manages Codex routing, sync or restart applies the selected model and effort as native Codex [agents] defaults for new Codex tasks. This does not cause delegation; existing user-owned [agents] defaults are preserved rather than overwritten.",
  "dash.multiAgentGuidance": "OpenCodex multi-agent guidance",
  "dash.multiAgentGuidanceHint": "Adds OpenCodex-authored delegation instructions. This is separate from the native Codex defaults above and does not change the v1/v2 surface, sub-agent roster, routing, or effort caps.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.autoSwitch": "Automatic account switching",
  "codexAuth.autoSwitchDesc": "Switches at {threshold}% usage or above when an eligible account has lower usage; Go/Free use 30d only",
  ...
  "api.authResponses": "Responses requests require x-opencodex-api-key because Authorization may be reserved for Codex Direct passthrough.",
  "api.authChatCompletions": "Chat Completions and /v1/models accept Authorization: Bearer ocx_... or x-opencodex-api-key.",
  ...
  "api.authMessages": "Messages accepts Authorization: Bearer ocx_... or x-opencodex-api-key.",
