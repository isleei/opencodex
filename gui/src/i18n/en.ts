...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.switchDesc": "This applies to the next request from existing and new Codex sessions. In-flight requests keep their captured account.",
  "codexAuth.cacheWarning": "OpenCodex replays the conversation after any account change, but the provider-side prompt cache may be cold.",
  "codexAuth.setAsNext": "Select Account",
  "codexAuth.cancel": "Cancel",
  "codexAuth.switchBack": "Switch back to Main?",
  "codexAuth.switchBackDesc": "The next request from existing and new Codex sessions will use your App login account.",
