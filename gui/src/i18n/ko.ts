...
export const ko: Record<TKey, string> = {
  ...
  "dash.injectionHint": "아래 두 제어가 함께 사용할 모델과 선택적인 추론 강도를 고릅니다.",
  "dash.syncCodexSubagentDefaults": "네이티브 Codex 서브에이전트 기본값으로 사용",
  "dash.syncCodexSubagentDefaultsHint": "기본적으로 꺼져 있습니다. OpenCodex가 Codex 라우팅을 관리하는 경우 동기화하거나 재시작하면 선택한 모델과 추론 강도를 새 Codex 작업의 네이티브 Codex [agents] 기본값으로 적용합니다. 이 설정 자체가 위임을 일으키지는 않으며, 기존 사용자 소유 [agents] 기본값은 덮어쓰지 않고 보존합니다.",
  "dash.multiAgentGuidance": "OpenCodex 멀티 에이전트 가이던스",
  "dash.multiAgentGuidanceHint": "OpenCodex가 작성한 위임 안내를 추가합니다. 위의 네이티브 Codex 기본값과 별개이며 v1/v2 표면, 서브에이전트 로스터, 라우팅, effort 상한은 바꾸지 않습니다.",
  ...
  "codexAuth.autoSwitchDesc": "사용량이 {threshold}% 이상이고 사용량이 더 낮은 정상 계정이 있으면 전환합니다. Go/Free는 30일만 봅니다",
