...
"common.discard": "버리기",
  ...
  "dash.offline": "오프라인",
  "dash.version": "버전",
  "dash.versionLocal": "로컬 버전",
  "dash.versionRemote": "npm 최신",
  "dash.installSource": "소스 실행",
  "dash.installNpm": "npm 전역",
  "dash.installBun": "bun 전역",
  "dash.installUnknown": "설치 방식 알 수 없음",
  "dash.uptime": "가동 시간",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "usage.search.accounts": "계정 검색…",
  "usage.col.requests": "요청",
  "usage.col.measured": "측정됨",
  "usage.col.reported": "측정됨",
  "usage.col.tokens": "토큰",
  "usage.col.account": "계정",
  "usage.col.share": "비율",
  "usage.account.filteredNotice": "프로바이더 또는 모델 필터가 적용된 상태에서는 계정별 합계가 표시되지 않습니다. 필터를 해제하여 계정별 사용량을 확인하세요.",
  "usage.account.ambiguous": "모호함",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "integrations.semantics.cline": "Cline의 providers.json에서 providers.opencodex만 관리합니다. 다른 공급자나 설정은 변경되지 않습니다. 새 세션에 적용됩니다.",
 ...
 "quota.fiveHourLimit": "5시간 한도",
  ...
  "quota.monthlyCredits": "월간 크레딧",
  "quota.requestWindow": "요청 윈도우",
  ...
  "pws.accountPlan": "계정 플랜",
  "pws.accountPlanOnly": "{plan} — 월간 크레딧 풀 없음(Grok CLI OAuth는 웹 작업 횟수 한도를 제공하지 않음).",
  "pws.selected": "선택됨",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "sessions.total": "총 세션 수",
  "sessions.view.flat": "타임라인",
  "sessions.view.grouped": "프로젝트별",
  "sessions.filter.all": "모든 에이전트",
  "sessions.filter.all_projects": "모든 프로젝트",
  "sessions.project.sessions_count": "{count}개 세션",
  "sessions.search.placeholder": "세션 프롬프트, ID, 파일 검색...",
  "sessions.loading": "에이전트 세션 스캔 중...",
  "sessions.empty.title": "에이전트 세션을 찾을 수 없음",
  "sessions.empty.desc": "OpenAI Codex, Antigravity (AGY), Claude Code 또는 Grok Build에서 작업을 실행하면 여기에 표시됩니다.",
  "workflows.workspace": "프로젝트 디렉터리 (서버의 절대 경로)",
  "workflows.requirements": "전체 요구 사항",
  "workflows.agent": "실행 도구",
  "workflows.rejectionNote": "거부 이유 / 수정 요청",
  "workflows.baseRevision": "리뷰 기준 리비전 (선택, 기본값은 생성 시 HEAD)",
  "workflows.monitor.subtitle": "진행 상황, 결과, 승인은 여기서 확인하고 작업은 Codex 대화에서 시작하세요.",
  "workflows.monitor.title": "Codex 대화에서 요청",
  "workflows.monitor.hint": "프로젝트 대화에서 작업을 설명하세요. Codex가 기록하고 이 페이지에 진행 상황과 승인 요청이 표시됩니다.",
  "workflows.monitor.example": "현재 프로젝트에서 ocx-workflow를 사용하세요. 계획은 당신이, 구현은 OpenCode가, 검토는 당신이 담당하세요. 계획 후 제 승인을 기다리세요. 요구 사항: [변경 내용과 승인 기준].",
  "workflows.monitor.copy": "요청 복사",
  "workflows.monitor.history": "종료된 작업 표시 ({count})",
  "workflows.monitor.empty": "진행 중인 작업이 없습니다. Codex 프로젝트 대화에서 시작하세요.",
  "workflows.monitor.feature": "계획 → 구현 → 검토",
  "workflows.monitor.audit": "독립 코드 검토",
  "workflows.monitor.debug": "조사 → 수정 → 검증",
  "workflows.monitor.executing": "실행 중입니다. 단계별 결과가 여기에 표시됩니다.",
  "workflows.monitor.resumeHint": "원래 Codex 대화로 돌아가 계속하세요. 여기서 승인해도 대화가 자동 재개되지는 않습니다.",
  "workflows.monitor.resume": "ocx-workflow 작업 {id}의 저장된 상태를 읽고 현재 단계를 계속하세요. 승인 대기 단계에서는 제 결정을 기다리세요.",
  "workflows.templates.title": "템플릿 선택",
  "workflows.templates.create": "내 템플릿으로 저장",
  "workflows.templates.hint": "저장된 템플릿을 선택한 뒤 Codex에서 요청하세요. 도구와 모델 설정을 재사용합니다.",
  "workflows.templates.personal": "내 템플릿",
  "workflows.templates.planner": "계획",
  "workflows.templates.worker": "구현",
  "workflows.templates.reviewer": "검토",
  "workflows.templates.api": "OpenCodex API",
  "workflows.templates.unset": "모델 미설정",
  "workflows.templates.conversationHint": "계획과 검토는 현재 Codex 대화에서 진행합니다. 구현 도구와 모델은 템플릿을 따르며, 누락된 모델은 한 번 설정하면 됩니다.",
  "workflows.templates.configure": "템플릿 설정",
  "workflows.templates.prompt": "현재 프로젝트에 ocx-workflow 템플릿 \"{id}\"를 사용하세요. 저장된 단계, 구현 도구, 모델, 승인 절차를 따르고 계획과 검토는 이 대화에서 수행하세요. 요구 사항: [변경 내용과 승인 기준].",
  "workflows.templates.roleTool": "{role} 도구",
  "workflows.templates.perPhase": "단계별 설정",
  "workflows.templates.conversation": "현재 Codex 대화",
  "workflows.title": "워크플로",
  "workflows.subtitle": "Codex 주도 단계형 모델 실행: 한 모델로 계획하고, 다른 모델로 구현하고, 병합 전에 검토합니다.",
  "workflows.refresh": "새로고침",
  "workflows.newRun": "새 실행",
  "workflows.runs": "실행",
  "workflows.empty": "아직 워크플로 실행이 없습니다. \"새 실행\"으로 시작하세요.",
  "workflows.definitions": "정의",
  "workflows.builtin": "내장",
  "workflows.phaseProgress": "단계 {index}/{total}",
  "workflows.status.awaiting": "게이트 대기: {gate}",
  "workflows.status.running": "실행 중",
  "workflows.status.completed": "완료",
  "workflows.status.aborted": "중단됨",
  "workflows.start.title": "워크플로 실행 시작",
  "workflows.start.workflow": "워크플로",
  "workflows.start.titleField": "제목",
  "workflows.start.roleModel": "역할 \"{role}\"의 모델",
  "workflows.start.auto": "다음 게이트까지 자동으로 단계 실행",
  "workflows.start.submit": "실행 시작",
  "workflows.startAutoNotice": "실행 시작 — 다음 게이트까지 자동 진행",
  "workflows.startNotice": "실행 시작됨",
  "workflows.runSaved": "워크플로 \"{id}\" 저장됨",
  "workflows.runDeleted": "워크플로 \"{id}\" 삭제됨",
  "workflows.deleteConfirm": "사용자 워크플로 \"{id}\"를 삭제하시겠습니까? 진행 중인 실행에는 영향이 없습니다.",
  "workflows.copied": "복사됨",
  "workflows.copyStatus": "상태 복사",
  "workflows.close": "닫기",
  "workflows.journal": "저널",
  "workflows.gateWaiting": "게이트 대기 중: {gate}",
  "workflows.gateApprove": "승인",
  "workflows.gateReject": "거부",
  "workflows.executePhase": "단계 실행",
  "workflows.advance": "진행",
  "workflows.abort": "중단",
  "workflows.outputsPlaceholder": "현재 단계의 출력 기록 (선택)…",
  "workflows.notice.advanced": "진행됨",
  "workflows.notice.gateApproved": "게이트 승인됨",
  "workflows.notice.gateRejected": "게이트 거부 — 재작업으로 반환",
  "workflows.notice.aborted": "실행 중단됨",
  "workflows.notice.alreadyExecuting": "이미 실행 중",
  "workflows.notice.executeStarted": "단계 실행 시작됨",
  "workflows.editor.customize": "\"{id}\" 사용자 정의",
  "workflows.editor.edit": "워크플로 편집",
  "workflows.editor.new": "새 워크플로",
  "workflows.editor.overrideNote": "저장하면 같은 ID의 사용자 정의가 저장되어 내장 정의를 덮어씁니다. 나중에 삭제하면 내장 정의로 복원됩니다.",
  "workflows.editor.id": "워크플로 ID",
  "workflows.editor.title": "제목",
  "workflows.editor.description": "설명",
  "workflows.editor.defaults": "기본 모델 (역할 → 모델 참조)",
  "workflows.editor.defaultsPlaceholder": "provider/model | combo/id | policy/id",
  "workflows.editor.noRoles": "아직 역할이 없습니다. 단계에서 role:planner 같은 참조를 사용하세요.",
  "workflows.editor.phases": "단계 (위부터 실행)",
  "workflows.editor.phaseIdPlaceholder": "단계-id",
  "workflows.editor.modelRefPlaceholder": "모델 참조 (role:planner 또는 provider/model)",
  "workflows.editor.gateIdPlaceholder": "게이트-id",
  "workflows.editor.promptPlaceholder": "이 단계의 프롬프트…",
  "workflows.editor.inputsPlaceholder": "이전 단계의 입력, 쉼표로 구분 (예: plan, diff)",
  "workflows.editor.rejectNearest": "거부 → 가장 가까운 이전 작업 단계",
  "workflows.editor.rejectTo": "거부 → {phase}",
  "workflows.editor.addPhase": "+ 작업 단계",
  "workflows.editor.addGate": "+ 게이트",
  "workflows.editor.cancel": "취소",
  "workflows.editor.save": "워크플로 저장",
  "workflows.editor.saving": "저장 중…",
  "workflows.editor.errId": "워크플로 ID는 영숫자여야 합니다 (.-_ 허용).",
  "workflows.editor.errPhaseRequired": "최소 1개의 단계가 필요합니다.",
  "workflows.editor.errPhaseId": "잘못된 단계 ID: {id}",
  "workflows.editor.errDuplicate": "중복 단계 ID: {id}",
  "workflows.editor.errFirstGate": "첫 단계는 게이트일 수 없습니다.",
  "workflows.go.placeholder": "원하는 작업을 적으세요 — 예: 로그인 API에 레이트 리밋 추가",
  "workflows.go.button": "실행",
  "workflows.go.hint": "한 단계: 엔진이 워크플로를 고르고 기본 모델로 실행하며 승인 게이트에서 멈춥니다.",
  "workflows.go.started": "시작됨 — 승인 게이트에서 멈춥니다",
  "sessions.action.inspect": "세부정보",
  "sessions.action.handoff": "세션 인계",
  "sessions.handoff.title": "크로스 에이전트 세션 인계",
  "sessions.handoff.strategy": "인계 전략",
  "sessions.handoff.custom": "추가 지침 (선택 사항)",
  "skillsMcp.subtitle": "중앙 집중식 스킬 저장소 및 다중 클라이언트 MCP 서버 구성.",
  "skillsMcp.tabsLabel": "스킬 및 MCP 관리 탭",
  "skillsMcp.tab.skills": "스킬",
  "skillsMcp.tab.mcp": "MCP 서버",
  "skillsMcp.skills.searchPlaceholder": "이름, 설명, 태그, 작성자, 내용으로 스킬 검색…",
  "skillsMcp.skills.filterStatusLabel": "상태별 필터",
  "skillsMcp.skills.filterStatusAll": "모든 상태",
  "skillsMcp.skills.filterStatusActive": "활성",
  "skillsMcp.skills.filterStatusDisabled": "비활성",
  "skillsMcp.skills.filterAgentLabel": "에이전트별 필터",
  "skillsMcp.skills.filterAgentAll": "모든 에이전트",
  "skillsMcp.skills.filterTagLabel": "태그별 필터",
  "skillsMcp.skills.filterTagAll": "모든 태그",
  "skillsMcp.skills.syncAllBtn": "모든 심볼릭 링크 동기화",
  "skillsMcp.skills.syncing": "동기화 중…",
  "skillsMcp.skills.syncSuccess": "{synced}개의 심볼릭 링크가 성공적으로 동기화되었습니다({migrated}개 마이그레이션, {deduped}개 중복 제거).",
  "skillsMcp.skills.trashBtn": "휴지통 / 복원",
  "skillsMcp.skills.newSkillBtn": "새 스킬",
  "skillsMcp.skills.emptyTitle": "설치된 스킬 없음",
  "skillsMcp.skills.emptyFilteredTitle": "선택한 필터와 일치하는 스킬이 없습니다",
  "skillsMcp.skills.resetFiltersBtn": "필터 초기화",
  "skillsMcp.skills.colActive": "활성",
  "skillsMcp.skills.colName": "스킬 이름",
  "skillsMcp.skills.colDescription": "설명",
  "skillsMcp.skills.colTags": "태그",
  "skillsMcp.skills.colLinkedAgents": "연결된 에이전트",
  "skillsMcp.skills.colStorage": "저장 방식",
  "skillsMcp.skills.colActions": "작업",
  "skillsMcp.skills.toggleAria": "스킬 {name} 전환",
  "skillsMcp.skills.editBtn": "스킬 수정",
  "skillsMcp.skills.badgeSystem": "시스템",
  "skillsMcp.skills.byAuthor": "작성자: {author}",
  "skillsMcp.skills.filterByTag": "#{tag} 태그로 필터",
  "skillsMcp.skills.noAgentsLinked": "연결 없음",
  "skillsMcp.skills.storageSymlinked": "심볼릭 링크",
  "skillsMcp.skills.storageCentral": "중앙 저장소",
  "skillsMcp.skills.createSuccess": "'{name}' 스킬이 성공적으로 생성되었습니다.",
  "skillsMcp.skills.updateSuccess": "'{name}' 스킬이 성공적으로 업데이트되었습니다.",
  "skillsMcp.skills.deleteSuccess": "'{name}' 스킬이 휴지통으로 이동되었습니다.",
  "skillsMcp.skills.modal.createTitle": "새 스킬 생성",
  "skillsMcp.skills.modal.editTitle": "스킬 수정: {name}",
  "skillsMcp.skills.modal.viewEditOnly": "편집기 전용",
  "skillsMcp.skills.modal.viewSplit": "분할 보기",
  "skillsMcp.skills.modal.viewPreviewOnly": "미리보기 전용",
  "skillsMcp.skills.modal.tabEdit": "편집",
  "skillsMcp.skills.modal.tabSplit": "분할",
  "skillsMcp.skills.modal.tabPreview": "미리보기",
  "skillsMcp.skills.modal.deleteConfirmTitle": "이 스킬을 삭제하시겠습니까?",
  "skillsMcp.skills.modal.deleteConfirmBody": "'{name}'을(를) 휴지통으로 이동하면 모든 연결된 에이전트의 심볼릭 링크가 제거됩니다. 휴지통 / 복원에서 언제든지 복원할 수 있습니다.",
  "skillsMcp.skills.modal.fieldName": "스킬 이름 (디렉터리 식별자)",
  "skillsMcp.skills.modal.placeholderName": "예: git-workflow, code-reviewer",
  "skillsMcp.skills.modal.fieldVersion": "버전",
  "skillsMcp.skills.modal.fieldAuthor": "작성자 / 팀",
  "skillsMcp.skills.modal.placeholderAuthor": "예: OpenCodex Community",
  "skillsMcp.skills.modal.fieldTags": "태그 (쉼표로 구분)",
  "skillsMcp.skills.modal.fieldDescription": "설명 및 트리거 의도",
  "skillsMcp.skills.modal.placeholderDescription": "스킬의 기능과 트리거 키워드에 대한 간략한 설명…",
  "skillsMcp.skills.modal.fieldActive": "활성화 / 활성",
  "skillsMcp.skills.modal.sourceHeader": "Markdown 소스",
  "skillsMcp.skills.modal.previewHeader": "실시간 미리보기",
  "skillsMcp.skills.modal.placeholderContent": "지침, 예시, 규칙을 포함한 스킬 Markdown 본문을 여기에 작성…",
  "skillsMcp.skills.modal.errorNameRequired": "스킬 이름은 필수입니다.",
  "skillsMcp.skills.modal.errorNameInvalid": "스킬 이름에는 영문 소문자, 숫자, 하이픈, 밑줄만 사용할 수 있습니다.",
  "skillsMcp.skills.trash.modalTitle": "스킬 휴지통 및 복원",
  "skillsMcp.skills.trash.modalSubtitle": "삭제된 스킬은 여기에 안전하게 보관됩니다. 복원 시 모든 연결된 에이전트의 심볼릭 링크가 다시 생성됩니다.",
  "skillsMcp.skills.trash.emptyTitle": "휴지통이 비어 있습니다",
  "skillsMcp.skills.trash.emptyBody": "휴지통에 삭제된 스킬이 없습니다.",
  "skillsMcp.skills.trash.colSkill": "스킬 이름",
  "skillsMcp.skills.trash.colDeletedAt": "삭제 일시",
  "skillsMcp.skills.trash.colOriginalPath": "원래 경로",
  "skillsMcp.skills.trash.colAction": "작업",
  "skillsMcp.skills.trash.restoreBtn": "복원",
  "skillsMcp.skills.trash.restoring": "복원 중…",
  "skillsMcp.skills.trash.restoreSuccess": "'{name}' 스킬이 복원되고 심볼릭 링크가 재설정되었습니다.",
  "skillsMcp.mcp.searchPlaceholder": "ID, 명령, 인수, 환경 변수, URL로 MCP 서버 검색…",
  "skillsMcp.mcp.showSecrets": "비밀 정보 표시",
  "skillsMcp.mcp.maskSecrets": "비밀 정보 마스킹",
  "skillsMcp.mcp.addServerBtn": "MCP 서버 추가",
  "skillsMcp.mcp.emptyFilteredTitle": "검색어와 일치하는 MCP 서버가 없습니다",
  ...
  "skillsMcp.mcp.serverCount": "{count}개 서버",
  "skillsMcp.mcp.addServerToClient": "{client}에 서버 추가",
  "skillsMcp.mcp.noServersConfigured": "이 클라이언트에 구성된 MCP 서버가 없습니다.",
  "skillsMcp.mcp.toggleAria": "서버 {id} 전환",
  "skillsMcp.mcp.scopeProject": "프로젝트",
  "skillsMcp.mcp.editBtn": "서버 수정",
  "skillsMcp.mcp.cloneBtn": "다른 클라이언트로 복제",
  "skillsMcp.mcp.addSuccess": "MCP 서버 '{id}'이(가) 성공적으로 추가되었습니다.",
  "skillsMcp.mcp.updateSuccess": "MCP 서버 '{id}'이(가) 성공적으로 업데이트되었습니다.",
  "skillsMcp.mcp.deleteSuccess": "MCP 서버 '{id}'이(가) 성공적으로 삭제되었습니다.",
  "skillsMcp.mcp.cloneSuccess": "MCP 서버 '{id}'이(가) {target}에 복제되었습니다.",
  "skillsMcp.mcp.modal.createTitle": "MCP 서버 추가",
  "skillsMcp.mcp.modal.editTitle": "MCP 서버 수정: {id}",
  "skillsMcp.mcp.modal.fieldClient": "대상 클라이언트",
  "skillsMcp.mcp.modal.fieldTransport": "전송 프로토콜",
  "skillsMcp.mcp.modal.fieldServerId": "서버 식별자 (ID)",
  "skillsMcp.mcp.modal.placeholderServerId": "예: memory, sqlite, context7",
  "skillsMcp.mcp.modal.fieldCommand": "실행 명령",
  "skillsMcp.mcp.modal.fieldArgs": "인수",
  "skillsMcp.mcp.modal.fieldCwd": "작업 디렉터리 (선택 사항)",
  "skillsMcp.mcp.modal.fieldUrl": "원격 서버 URL (SSE / HTTP)",
  "skillsMcp.mcp.modal.fieldEnabled": "서버 활성화",
  "skillsMcp.mcp.modal.envHeader": "환경 변수",
  "skillsMcp.mcp.modal.addEnvVar": "변수 추가",
  "skillsMcp.mcp.modal.envEmptyNote": "구성된 환경 변수가 없습니다.",
  "skillsMcp.mcp.modal.errorIdRequired": "서버 ID는 필수입니다.",
  "skillsMcp.mcp.modal.errorCommandRequired": "stdio 전송에는 실행 명령이 필요합니다.",
  "skillsMcp.mcp.modal.errorUrlRequired": "SSE 전송에는 원격 서버 URL이 필요합니다.",
  "skillsMcp.mcp.clone.modalTitle": "MCP 서버 복제",
  "skillsMcp.mcp.clone.modalSubtitle": "{client}의 MCP 서버 '{id}'을(를) 자동 형식 변환과 함께 다른 클라이언트로 복사합니다.",
  "skillsMcp.mcp.clone.sourceLabel": "소스 서버",
  "skillsMcp.mcp.clone.targetClientLabel": "대상 클라이언트",
  "skillsMcp.mcp.clone.newIdLabel": "대상 서버 ID",
  "skillsMcp.mcp.clone.overwriteLabel": "서버 ID가 이미 존재하는 경우 대상 구성을 덮어씁니다",
  "skillsMcp.mcp.clone.cloneBtn": "서버 복제",
  ...
  "subscriptions.agy.title": "Google Antigravity (AGY) 멀티 계정 매트릭스",
  "subscriptions.agy.desc": "{count}개의 Google 계정이 구성되었습니다. '현재 활성 계정으로 설정'을 클릭하여 CLI 및 IDE와 동기화하세요.",
  "subscriptions.agy.setActive": "현재 활성 계정으로 설정",
  "subscriptions.agy.currentlyActive": "현재 사용 중",
  "subscriptions.agy.switching": "전환 중…",
  "subscriptions.agy.syncPanelTitle": "AGY 동기화 상태(이 프록시 호스트)",
  "subscriptions.agy.rowProxy": "프록시 활성 계정: {account}",
  "subscriptions.agy.rowCli": "CLI 자격 증명: {status}",
  "subscriptions.agy.rowIde": "IDE 동기화: {status}",
  "subscriptions.agy.status.synced": "동기화됨",
  "subscriptions.agy.status.pending_restart": "대기 중 — IDE를 정상 종료한 뒤 다시 시도",
  "subscriptions.agy.status.failed": "실패",
  "subscriptions.agy.status.unsupported": "지원 안 됨",
  "subscriptions.agy.status.not_installed": "설치 안 됨",
  "subscriptions.agy.status.unknown": "알 수 없음",
  "subscriptions.agy.retrySync": "현재 계정 동기화 다시 시도",
  "subscriptions.agy.proxyHostNote": "동기화는 이 프록시가 실행 중인 머신에 적용됩니다(브라우저 머신과 다를 수 있음). CLI는 전환 후 시작된 agy 프로세스부터 적용됩니다.",
  "subscriptions.agy.nativeKeyringNote": "참고: macOS에서는 OS 키체인 항목을 쓰고 다시 읽어 검증합니다. 다른 플랫폼에서는 CLI 파일만 동기화됩니다.",
  "subscriptions.agy.switchPartial": "{target} 동기화 확인 필요: {detail}",
  "subscriptions.agy.switchUnknown": "전환 결과를 알 수 없음: {detail}. 상태를 새로고침했습니다 — 동기화 패널을 확인하고 필요하면 다시 시도하세요.",
  "subscriptions.agy.cliOnlyNoIde": "{account}(으)로 전환했습니다. CLI 동기화됨. Antigravity IDE가 이 호스트에 설치되어 있지 않습니다.",
  "subscriptions.agy.noActiveAccount": "없음",

  "subscriptions.agy.quota.gemini": "Gemini",
  "subscriptions.agy.quota.claudeGpt": "Claude / GPT",
  "subscriptions.agy.quota.weekly": "주간",
  "subscriptions.agy.quota.fiveHour": "5시간",
  "subscriptions.agy.quota.stale": "만료된 캐시 값",
  "subscriptions.agy.quota.updating": "한도 업데이트 중…",
  "subscriptions.agy.quota.staleRetry": "업데이트 실패. 마지막 성공 값을 표시하며 30초 후 재시도합니다.",
  "subscriptions.agy.quota.scopeNote": "그룹별로 공유하는 주간 및 5시간 구독 한도입니다.",
  "subscriptions.agy.quota.unknown": "할당량 알 수 없음",
  "subscriptions.agy.quota.unavailable": "할당량을 사용할 수 없음",
  "subscriptions.agy.quota.unavailableHint": "마지막 조회 실패; 캐시된 값을 현재값으로 표시하지 않습니다.",
  "subscriptions.agy.quota.remaining": "{pct}% 남음",
  "subscriptions.agy.quota.resetUnknown": "리셋 알 수 없음",
  "subscriptions.agy.quota.observedLabel": "관측",
  "subscriptions.agy.quota.observedAt": "{time}에 관측",
  "subscriptions.agy.quota.observedUnknown": "관측 시간 알 수 없음",
  "subscriptions.codex.title": "OpenAI Codex 구독 및 할당량",
  "subscriptions.codex.tickets": "재설정 크레딧: {count}개 사용 가능",
  "subscriptions.grok.title": "xAI Grok 구독 및 할당량",
  "subscriptions.other.title": "기타 연결된 구독",
  "subscriptions.noAccounts": "이 구독에 로그인된 계정이 없습니다",
  "subscriptions.switchSuccess": "현재 활성 계정을 {account}(으)로 전환했습니다",
