...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.switchDesc": "Dies gilt für die nächste Anfrage bestehender und neuer Codex-Sitzungen. Laufende Anfragen behalten ihr Konto.",
  "codexAuth.cacheWarning": "OpenCodex spielt den Gesprächskontext nach jedem Kontowechsel erneut ab, aber der providerseitige Prompt-Cache kann kalt sein.",
  "codexAuth.setAsNext": "Konto auswählen",
  "codexAuth.cancel": "Abbrechen",
  "codexAuth.switchBack": "Zurück zum Hauptkonto?",
  "codexAuth.switchBackDesc": "Die nächste Anfrage bestehender und neuer Codex-Sitzungen verwendet dein App-Login-Konto.",
