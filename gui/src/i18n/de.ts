...
export const de: Record<TKey, string> = {
  ...
  "dash.mem.jsHeap": "JS-Heap (belegt / gesamt)",
  ...
  "dash.injectionHint": "Wähle das Modell und den optionalen Aufwand, die von den beiden Steuerelementen unten gemeinsam verwendet werden.",
  "dash.syncCodexSubagentDefaults": "Als native Codex-Subagent-Standardwerte verwenden",
  "dash.syncCodexSubagentDefaultsHint": "Standardmäßig deaktiviert. Wenn OpenCodex das Codex-Routing verwaltet, wendet eine Synchronisierung oder ein Neustart das ausgewählte Modell und den Aufwand als native Codex-[agents]-Standardwerte für neue Codex-Aufgaben an. Dies löst keine Delegation aus; vorhandene benutzereigene [agents]-Standardwerte bleiben erhalten und werden nicht überschrieben.",
  "dash.multiAgentGuidance": "OpenCodex-Multi-Agent-Anleitung",
  "dash.multiAgentGuidanceHint": "Fügt von OpenCodex erstellte Delegationshinweise hinzu. Dies ist von den nativen Codex-Standards oben getrennt und ändert weder v1/v2-Oberfläche, Sub-Agent-Liste, Routing noch Aufwandsgrenzen.",
  ...
  "codexAuth.autoSwitch": "Automatischer Kontowechsel",
  "codexAuth.autoSwitchDesc": "Wechselt ab {threshold} % Auslastung, wenn ein verfügbares Konto eine niedrigere Auslastung hat; Go/Free nutzen nur das 30-Tage-Fenster",
  ...
  "accountPool.strategyDesc": "Wie neue Sitzungen ein Konto aus dem Pool wählen.",
