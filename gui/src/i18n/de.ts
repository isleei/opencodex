...
"common.discard": "Verwerfen",
  ...
  "dash.versionLocal": "Lokale Version",
  "dash.versionRemote": "npm aktuell",
  "dash.installSource": "Quellcode",
  "dash.installNpm": "npm global",
  "dash.installBun": "bun global",
  "dash.installUnknown": "Installation unbekannt",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "usage.search.accounts": "Konten durchsuchen…",
  "usage.col.requests": "Anfragen",
  "usage.col.measured": "Gemessen",
  "usage.col.reported": "Gemeldet",
  "usage.col.tokens": "Tokens",
  "usage.col.account": "Konto",
  "usage.col.share": "Anteil",
  "usage.account.filteredNotice": "Gesamtsummen pro Konto werden unter einem Anbieter- oder Modellfilter nicht gemeldet. Ohne Filter ausführen.",
  "usage.account.ambiguous": "mehrdeutig",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "integrations.semantics.cline": "Verwaltet nur providers.opencodex in der providers.json von Cline. Andere Provider und Einstellungen bleiben unverändert. Gilt für neue Sitzungen.",
 ...
 "quota.fiveHourLimit": "5-Stunden-Limit",
  ...
  "quota.monthlyCredits": "Monatliches Guthaben",
  "quota.requestWindow": "Anfragefenster",
  "quota.grokBuild": "GrokBuild",
  ...
  "pws.accountPlan": "Kontotarif",
  "pws.accountPlanOnly": "{plan} — kein monatliches Guthaben (Grok-CLI-OAuth liefert keine Web-Aufgabenlimits).",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cloud.statusHint": "Local device id and last OneDrive push/pull.",
  "cloud.loggedIn": "Microsoft account",
  "cloud.notLoggedIn": "Not signed in",
  "cloud.account": "Account",
  "cloud.device": "This device",
  "cloud.remote": "Remote folder",
  "cloud.lastSync": "Last sync",
  "cloud.never": "Never",
  "cloud.remoteManifest": "Cloud snapshot",
  "cloud.hasVault": "encrypted vault",
  "cloud.remoteError": "Cloud check",
  "cloud.clientIdTitle": "Azure app client ID",
  "cloud.clientIdHint": "Create a public client app in Azure AD once, enable “Allow public client flows”, add delegated scopes Files.ReadWrite and offline_access, then paste the Application (client) ID here.",
  "cloud.clientIdSaved": "Client ID saved.",
  "cloud.azurePortal": "Azure app registrations",
  "cloud.azureSteps": "Public client · device code · Files.ReadWrite + offline_access",
  "cloud.loginTitle": "Sign in to Microsoft",
  "cloud.login": "Sign in with Microsoft",
  "cloud.logout": "Sign out",
  "cloud.loginOk": "Signed in as {account}",
  "cloud.loginFailed": "Microsoft sign-in failed",
  "cloud.logoutOk": "Signed out of OneDrive.",
  "cloud.deviceCodeTitle": "Device code",
  "cloud.deviceCodeHint": "Open the link, enter this code, then approve access:",
  "cloud.waitingAuth": "Waiting for Microsoft approval…",
  "cloud.transferTitle": "Push / pull",
  "cloud.transferHint": "Push uploads config to OneDrive. Pull overwrites this machine’s ~/.opencodex from the cloud snapshot.",
  "cloud.passphrase": "Vault passphrase",
  "cloud.passphrasePlaceholder": "Min 8 characters (encrypts oauth tokens)",
  "cloud.passphraseShort": "Passphrase must be at least 8 characters when the vault is enabled.",
  "cloud.includeVault": "Include encrypted token vault (oauth.json / auth.json)",
  "cloud.includeUsage": "Include usage / logs DBs (larger)",
  "cloud.push": "Push to OneDrive",
  "cloud.pull": "Pull from OneDrive",
  "cloud.pushOk": "Pushed: {files}",
  "cloud.pullOk": "Pulled: {files}",
  "cloud.pullConfirm": "Pull will overwrite local OpenCodex config and auth files from OneDrive. Continue?",
  "cloud.securityNote": "Plain config is stored under OneDrive/OpenCodex/sync/. OAuth tokens only go into the AES-256-GCM vault when you set a passphrase. Never share your client secret or vault passphrase.",
  "cloud.loginHint": "Browser login (recommended): Azure platform “Mobile and desktop” + redirect URI http://localhost. Device code needs Allow public client flows = Yes.",
  "cloud.loginDevice": "Device code (advanced)",
  "cloud.browserLoginTitle": "Browser sign-in",
  "cloud.browserLoginHint": "Complete Microsoft sign-in in the opened tab, then return here.",
  "cloud.openAuthPage": "Open sign-in page",
  "cloud.redirectUri": "Loopback redirect",
  "cloud.redirectUriTitle": "Register this exact redirect URI in Azure",
  "cloud.redirectUriHint": "Authentication → Add a platform → Mobile and desktop applications → custom redirect URI (must match exactly, including port):",
  "cloud.redirectUriWhere": "Do not use #cloud, port 10100, or https. Save, wait ~1 minute, then sign in.",
  "cloud.clientIdSecretSaved": "Client ID and client secret saved.",
  "cloud.clientSecret": "Client secret (optional)",
  "cloud.clientSecretPlaceholder": "Only if Azure requires client_secret",
  "cloud.clientSecretSet": "Secret saved (leave empty and save to clear; type a new value to replace)",
  "cloud.clientSecretHint": "Preferred: Authentication → Allow public client flows = Yes (no secret). For Web apps, create a client secret under Certificates & secrets, paste here, then Save.",
  ...
  "nav.pi": "Pi",
  "pi.title": "Pi",
  "pi.subtitle": "Manage Pi models, settings, packages, and extensions. Only the opencodex provider block is written to models.json.",
  "pi.loading": "Loading Pi status…",
  "pi.loadFail": "Could not read Pi status.",
  "pi.actionOk": "Done.",
  "pi.actionFail": "Action failed.",
  "pi.applySkipped": "Pi apply was skipped (policy or missing install).",
  "pi.statusTitle": "Install status",
  "pi.binary": "pi binary",
  "pi.agentDir": "Agent directory",
  "pi.modelsFile": "models.json",
  "pi.missing": "not found",
  "pi.modelsTitle": "Models (providers.opencodex)",
  "pi.modelsHint": "Apply writes only providers.opencodex from the live catalog. Your other providers stay untouched.",
  "pi.apply": "Apply models",
  "pi.applying": "Applying…",
  "pi.applied": "Pi models applied.",
  "pi.remove": "Remove opencodex block",
  "pi.removing": "Removing…",
  "pi.removed": "Pi opencodex provider removed.",
  "pi.modelsNotPresentTitle": "opencodex not in models.json yet",
  "pi.modelsNotPresentHint": "Click Apply to register the current catalog as providers.opencodex.",
  "pi.endpoint": "Endpoint",
  "pi.modelCount": "{count} models registered",
  "pi.moreModels": "…and {n} more",
  "pi.settingsTitle": "Settings",
  "pi.settingsHint": "Curated subset of ~/.pi/agent/settings.json. Unknown keys are preserved.",
  "pi.saveSettings": "Save settings",
  "pi.savingSettings": "Saving…",
  "pi.settingsSaved": "Pi settings saved.",
  "pi.defaultProvider": "Default provider",
  "pi.defaultModel": "Default model",
  "pi.thinking": "Thinking level",
  "pi.theme": "Theme",
  "pi.projectTrust": "Project trust default",
  "pi.hideThinking": "Hide thinking blocks",
  "pi.quietStartup": "Quiet startup",
  "pi.unset": "(unset)",
  "pi.otherKeys": "{count} other keys left untouched",
  "pi.packagesTitle": "Packages",
  "pi.packagesHint": "Install runs `pi install` on the server machine. Packages execute with full system access — review sources before installing.",
  "pi.install": "Install",
  "pi.installing": "Installing…",
  "pi.packageInstalled": "Package install finished.",
  "pi.packageRemoved": "Package removed.",
  "pi.removePackage": "Remove",
  "pi.noPackages": "No packages in settings.json.",
  "pi.extensionsTitle": "Extensions",
  "pi.extensionsHint": "Auto-discovered under ~/.pi/agent/extensions plus paths listed in settings. Source editing is not available here.",
  "pi.noExtensions": "No extensions found.",
  "pi.cliHint": "CLI: ocx pi status | apply | settings | packages · launch with ocx pi",
  "grok.modelsSection": "Grok Build models",
  "grok.modelsSectionSub": "Choose which opencodex models appear in Grok Build, then save and apply.",
  "grok.account.sectionAria": "xAI account and quota",
  "grok.account.title": "xAI account quota",
  "grok.account.subtitle": "Same depth as Codex Auth: active Grok account, plan, and usage bars. No need to open Providers.",
  "grok.account.refreshQuota": "Refresh quota",
  "grok.account.refreshing": "Refreshing…",
  "grok.account.addAccount": "Add account",
  "grok.account.login": "Log in with xAI",
  "grok.account.loggingIn": "Waiting for login…",
  "grok.account.cancelLogin": "Cancel login",
  "grok.account.loading": "Loading accounts…",
  "grok.account.empty": "No xAI account yet. Log in to see plan and quota bars here.",
  "grok.account.loadFail": "Could not load xAI accounts.",
  "grok.account.loginFail": "xAI login failed to start.",
  "grok.account.loginOk": "xAI login succeeded.",
  "grok.account.loginCancelled": "xAI login cancelled.",
  "grok.account.select": "Select account",
  "grok.account.switched": "Active xAI account updated.",
  "grok.account.switchFail": "Could not switch xAI account.",
  "grok.account.removeConfirm": "Remove this xAI account from opencodex?",
  "grok.account.removeFail": "Could not remove account.",
  "grok.account.removed": "Account removed.",
  "grok.account.unnamed": "xAI account",
  "nav.clients": "Clients",
  "clients.title": "Clients",
  "clients.subtitle": "See which base URL and model each coding agent is actually using on disk — useful when CC Switch, ocx inject, and launchers stack.",
  "clients.refresh": "Refresh",
  "clients.loadFail": "Could not read client status.",
  "clients.proxyTitle": "Proxy",
  "clients.proxyRunning": "Proxy running",
  "clients.proxyStopped": "Proxy not detected",
  "clients.generatedAt": "Checked {time}",
  "clients.readOnlyHint": "Read-only. This page never rewrites client configs or shows API keys.",
  "clients.tableTitle": "Effective client routing",
  "clients.col.client": "Client",
  "clients.col.verdict": "Verdict",
  "clients.col.baseUrl": "Base URL",
  "clients.col.model": "Model",
  "clients.col.launcher": "Launcher",
  "clients.col.switcher": "Switcher profile",
  "clients.col.details": "Details",
  "clients.col.configPaths": "Config paths",
  "clients.col.notes": "Notes",
  "clients.verdict.ocx": "via ocx",
  "clients.verdict.direct": "direct",
  "clients.verdict.mixed": "mixed",
  "clients.verdict.missing": "missing",
  "clients.verdict.unknown": "unknown",
  ...
  "sessions.total": "Sitzungen gesamt",
  "sessions.view.flat": "Zeitachse",
  "sessions.view.grouped": "Nach Projekt",
  "sessions.filter.all": "Alle Agenten",
  "sessions.filter.all_projects": "Alle Projekte",
  "sessions.project.sessions_count": "{count} Sitzungen",
  "sessions.search.placeholder": "Sitzungs-Prompt, ID, Dateien durchsuchen...",
  "sessions.loading": "Agenten-Sitzungen werden gescannt...",
  "sessions.empty.title": "Keine Agenten-Sitzungen gefunden",
  "sessions.empty.desc": "Führen Sie Aufgaben in OpenAI Codex, Antigravity (AGY), Claude Code oder Grok Build aus, damit Sitzungen hier erscheinen.",
  "workflows.workspace": "Projektverzeichnis (absoluter Pfad auf dem Server)",
  "workflows.requirements": "Vollständige Anforderungen",
  "workflows.agent": "Ausführungswerkzeug",
  "workflows.rejectionNote": "Ablehnungsgrund / gewünschte Korrekturen",
  "workflows.baseRevision": "Basisrevision (optional, standardmäßig HEAD bei Erstellung)",
  "workflows.monitor.subtitle": "Fortschritt, Ergebnisse und Freigaben hier verfolgen. Aufgaben im Codex-Gespräch starten.",
  "workflows.monitor.title": "Im Codex-Gespräch starten",
  "workflows.monitor.hint": "Beschreibe die Aufgabe im Projektgespräch. Codex erfasst den Workflow; diese Seite zeigt Fortschritt und Freigaben.",
  "workflows.monitor.example": "Nutze ocx-workflow für dieses Projekt: Du planst, OpenCode implementiert, danach prüfst du. Warte nach dem Plan auf meine Freigabe. Aufgabe: [Änderung und Abnahmekriterien].",
  "workflows.monitor.copy": "Anweisung kopieren",
  "workflows.monitor.history": "Beendete Aufgaben anzeigen ({count})",
  "workflows.monitor.empty": "Keine aktiven Aufgaben. Starte einen Workflow im Codex-Projektgespräch.",
  "workflows.monitor.feature": "Planen → Umsetzen → Prüfen",
  "workflows.monitor.audit": "Unabhängige Codeprüfung",
  "workflows.monitor.debug": "Untersuchen → Beheben → Prüfen",
  "workflows.monitor.executing": "Der Workflow läuft. Phasenergebnisse erscheinen hier.",
  "workflows.monitor.resumeHint": "Kehre zum ursprünglichen Codex-Gespräch zurück. Eine Freigabe hier setzt das Gespräch nicht automatisch fort.",
  "workflows.monitor.resume": "Setze ocx-workflow-Aufgabe {id} fort. Lies den gespeicherten Zustand und bearbeite die aktuelle Phase; warte bei ausstehenden Freigaben auf meine Entscheidung.",
  "workflows.templates.title": "Vorlage auswählen",
  "workflows.templates.create": "Als meine Vorlage speichern",
  "workflows.templates.hint": "Wähle eine gespeicherte Vorlage und beschreibe die Aufgabe in Codex. Werkzeug- und Modelleinstellungen werden wiederverwendet.",
  "workflows.templates.personal": "Meine Vorlage",
  "workflows.templates.planner": "Planung",
  "workflows.templates.worker": "Umsetzung",
  "workflows.templates.reviewer": "Prüfung",
  "workflows.templates.api": "OpenCodex API",
  "workflows.templates.unset": "Modell nicht konfiguriert",
  "workflows.templates.conversationHint": "Planung und Prüfung erfolgen in diesem Codex-Gespräch. Werkzeuge und Modelle für die Umsetzung stammen aus der Vorlage; fehlende Modelle einmal konfigurieren.",
  "workflows.templates.configure": "Vorlage konfigurieren",
  "workflows.templates.prompt": "Nutze ocx-workflow-Vorlage \"{id}\" für dieses Projekt. Befolge die gespeicherten Phasen, Werkzeuge, Modelle und Freigaben. Übernimm Planung und Prüfung in diesem Gespräch. Aufgabe: [Anforderungen und Abnahmekriterien].",
  "workflows.templates.roleTool": "Werkzeug für {role}",
  "workflows.templates.perPhase": "Pro Phase konfiguriert",
  "workflows.templates.conversation": "Aktuelles Codex-Gespräch",
  "workflows.title": "Workflows",
  "workflows.subtitle": "Von Codex geführte, phasenweise Modelläufe: Planung mit einem Modell, Umsetzung mit einem anderen, Review vor dem Merge.",
  "workflows.refresh": "Aktualisieren",
  "workflows.newRun": "Neuer Lauf",
  "workflows.runs": "Läufe",
  "workflows.empty": "Noch keine Workflow-Läufe. Starten Sie einen mit \"Neuer Lauf\".",
  "workflows.definitions": "Definitionen",
  "workflows.builtin": "integriert",
  "workflows.phaseProgress": "Phase {index}/{total}",
  "workflows.status.awaiting": "wartet auf Tor: {gate}",
  "workflows.status.running": "läuft",
  "workflows.status.completed": "abgeschlossen",
  "workflows.status.aborted": "abgebrochen",
  "workflows.start.title": "Workflow-Lauf starten",
  "workflows.start.workflow": "Workflow",
  "workflows.start.titleField": "Titel",
  "workflows.start.roleModel": "Modell für Rolle \"{role}\"",
  "workflows.start.auto": "Phasen automatisch bis zum nächsten Tor ausführen",
  "workflows.start.submit": "Lauf starten",
  "workflows.startAutoNotice": "Lauf gestartet — Ausführung bis zum nächsten Tor",
  "workflows.startNotice": "Lauf gestartet",
  "workflows.runSaved": "Workflow \"{id}\" gespeichert",
  "workflows.runDeleted": "Workflow \"{id}\" gelöscht",
  "workflows.deleteConfirm": "Benutzer-Workflow \"{id}\" löschen? Laufende Ausführungen sind nicht betroffen.",
  "workflows.copied": "Kopiert",
  "workflows.copyStatus": "Status kopieren",
  "workflows.close": "Schließen",
  "workflows.journal": "Protokoll",
  "workflows.gateWaiting": "Wartet am Tor: {gate}",
  "workflows.gateApprove": "Genehmigen",
  "workflows.gateReject": "Ablehnen",
  "workflows.executePhase": "Phase ausführen",
  "workflows.advance": "Weiter",
  "workflows.abort": "Abbrechen",
  "workflows.outputsPlaceholder": "Ergebnisse der aktuellen Phase festhalten (optional)…",
  "workflows.notice.advanced": "Weitergegangen",
  "workflows.notice.gateApproved": "Tor genehmigt",
  "workflows.notice.gateRejected": "Tor abgelehnt — zur Überarbeitung zurückgeschickt",
  "workflows.notice.aborted": "Lauf abgebrochen",
  "workflows.notice.alreadyExecuting": "Wird bereits ausgeführt",
  "workflows.notice.executeStarted": "Phasenausführung gestartet",
  "workflows.editor.customize": "„{id}\" anpassen",
  "workflows.editor.edit": "Workflow bearbeiten",
  "workflows.editor.new": "Neuer Workflow",
  "workflows.editor.overrideNote": "Das Speichern legt eine Benutzerdefinition mit derselben ID an — sie überschreibt die integrierte. Löschen Sie sie später, um die integrierte wiederherzustellen.",
  "workflows.editor.id": "Workflow-ID",
  "workflows.editor.title": "Titel",
  "workflows.editor.description": "Beschreibung",
  "workflows.editor.defaults": "Standardmodelle (Rolle → Modell-Ref)",
  "workflows.editor.defaultsPlaceholder": "provider/model | combo/id | policy/id",
  "workflows.editor.noRoles": "Noch keine Rollen — verwenden Sie Modell-Refs wie role:planner in einer Phase.",
  "workflows.editor.phases": "Phasen (oben läuft zuerst)",
  "workflows.editor.phaseIdPlaceholder": "phasen-id",
  "workflows.editor.modelRefPlaceholder": "Modell-Ref (role:planner oder provider/model)",
  "workflows.editor.gateIdPlaceholder": "tor-id",
  "workflows.editor.promptPlaceholder": "Prompt für diese Phase…",
  "workflows.editor.inputsPlaceholder": "Eingaben aus früheren Phasen, kommasepariert (z. B. plan, diff)",
  "workflows.editor.rejectNearest": "Ablehnen → nächste vorige Arbeitsphase",
  "workflows.editor.rejectTo": "Ablehnen → {phase}",
  "workflows.editor.addPhase": "+ Arbeitsphase",
  "workflows.editor.addGate": "+ Tor",
  "workflows.editor.cancel": "Abbrechen",
  "workflows.editor.save": "Workflow speichern",
  "workflows.editor.saving": "Speichern…",
  "workflows.editor.errId": "Workflow-ID muss alphanumerisch sein (.-_ erlaubt).",
  "workflows.editor.errPhaseRequired": "Mindestens eine Phase ist erforderlich.",
  "workflows.editor.errPhaseId": "Ungültige Phasen-ID: {id}",
  "workflows.editor.errDuplicate": "Doppelte Phasen-ID: {id}",
  "workflows.editor.errFirstGate": "Die erste Phase darf kein Tor sein.",
  "workflows.go.placeholder": "Beschreiben Sie, was Sie wollen — z. B. Rate-Limiting für die Login-API",
  "workflows.go.button": "Los",
  "workflows.go.hint": "Ein Schritt: Die Engine wählt den Workflow, nutzt Ihr Standardmodell und stoppt am Genehmigungs-Tor.",
  "workflows.go.started": "Gestartet — stoppt am Genehmigungs-Tor",
  "sessions.action.inspect": "Prüfen",
  "sessions.action.handoff": "Übergeben",
  "sessions.handoff.title": "Cross-Agent Sitzungsübergabe",
  "sessions.handoff.strategy": "Übergabestrategie",
  "sessions.handoff.custom": "Zusätzliche Anweisungen (Optional)",
  "skillsMcp.subtitle": "Zentrales Skill-Repository und Multi-Client MCP-Serverkonfiguration.",
  "skillsMcp.tabsLabel": "Reiter für Skills und MCP-Verwaltung",
  "skillsMcp.tab.skills": "Skills",
  "skillsMcp.tab.mcp": "MCP-Server",
  "skillsMcp.skills.searchPlaceholder": "Skills nach Name, Beschreibung, Tags, Autor, Inhalt durchsuchen…",
  "skillsMcp.skills.filterStatusLabel": "Nach Status filtern",
  "skillsMcp.skills.filterStatusAll": "Alle Status",
  "skillsMcp.skills.filterStatusActive": "Aktiv",
  "skillsMcp.skills.filterStatusDisabled": "Deaktiviert",
  "skillsMcp.skills.filterAgentLabel": "Nach Agent filtern",
  "skillsMcp.skills.filterAgentAll": "Alle Agenten",
  "skillsMcp.skills.filterTagLabel": "Nach Tag filtern",
  "skillsMcp.skills.filterTagAll": "Alle Tags",
  "skillsMcp.skills.syncAllBtn": "Alle Symlinks synchronisieren",
  "skillsMcp.skills.syncing": "Synchronisieren…",
  "skillsMcp.skills.syncSuccess": "{synced} Symlinks erfolgreich synchronisiert ({migrated} migriert, {deduped} dedupliziert).",
  "skillsMcp.skills.trashBtn": "Papierkorb / Wiederherstellung",
  "skillsMcp.skills.newSkillBtn": "Neuer Skill",
  "skillsMcp.skills.emptyTitle": "Keine Skills installiert",
  "skillsMcp.skills.emptyFilteredTitle": "Keine Skills entsprechen den gewählten Filtern",
  "skillsMcp.skills.resetFiltersBtn": "Filter zurücksetzen",
  "skillsMcp.skills.colActive": "Aktiv",
  "skillsMcp.skills.colName": "Skill-Name",
  "skillsMcp.skills.colDescription": "Beschreibung",
  "skillsMcp.skills.colTags": "Tags",
  "skillsMcp.skills.colLinkedAgents": "Verknüpfte Agenten",
  "skillsMcp.skills.colStorage": "Speicher",
  "skillsMcp.skills.colActions": "Aktionen",
  "skillsMcp.skills.toggleAria": "Skill {name} umschalten",
  "skillsMcp.skills.editBtn": "Skill bearbeiten",
  "skillsMcp.skills.badgeSystem": "System",
  "skillsMcp.skills.byAuthor": "von {author}",
  "skillsMcp.skills.filterByTag": "Nach #{tag} filtern",
  "skillsMcp.skills.noAgentsLinked": "Keine verknüpft",
  "skillsMcp.skills.storageSymlinked": "Symlink",
  "skillsMcp.skills.storageCentral": "Zentral",
  "skillsMcp.skills.createSuccess": "Skill '{name}' erfolgreich erstellt.",
  "skillsMcp.skills.updateSuccess": "Skill '{name}' erfolgreich aktualisiert.",
  "skillsMcp.skills.deleteSuccess": "Skill '{name}' in den Papierkorb verschoben.",
  "skillsMcp.skills.modal.createTitle": "Neuen Skill erstellen",
  "skillsMcp.skills.modal.editTitle": "Skill bearbeiten: {name}",
  "skillsMcp.skills.modal.viewEditOnly": "Nur Editor",
  "skillsMcp.skills.modal.viewSplit": "Geteilte Ansicht",
  "skillsMcp.skills.modal.viewPreviewOnly": "Nur Vorschau",
  "skillsMcp.skills.modal.tabEdit": "Bearbeiten",
  "skillsMcp.skills.modal.tabSplit": "Geteilt",
  "skillsMcp.skills.modal.tabPreview": "Vorschau",
  "skillsMcp.skills.modal.deleteConfirmTitle": "Diesen Skill löschen?",
  "skillsMcp.skills.modal.deleteConfirmBody": "Das Verschieben von '{name}' in den Papierkorb entfernt Symlinks aller verknüpften Agenten. Eine Wiederherstellung ist im Papierkorb möglich.",
  "skillsMcp.skills.modal.fieldName": "Skill-Name (Verzeichnisbezeichner)",
  "skillsMcp.skills.modal.placeholderName": "z.B. git-workflow, code-reviewer",
  "skillsMcp.skills.modal.fieldVersion": "Version",
  "skillsMcp.skills.modal.fieldAuthor": "Autor / Team",
  "skillsMcp.skills.modal.placeholderAuthor": "z.B. OpenCodex Community",
  "skillsMcp.skills.modal.fieldTags": "Tags (kommagetrennt)",
  "skillsMcp.skills.modal.fieldDescription": "Beschreibung & Trigger-Absicht",
  "skillsMcp.skills.modal.placeholderDescription": "Kurze Erklärung der Skill-Funktion und Trigger-Schlüsselwörter…",
  "skillsMcp.skills.modal.fieldActive": "Aktiviert / Aktiv",
  "skillsMcp.skills.modal.sourceHeader": "Markdown-Quellcode",
  "skillsMcp.skills.modal.previewHeader": "Live-Vorschau",
  "skillsMcp.skills.modal.placeholderContent": "Skill-Inhalt hier in Markdown verfassen mit Anweisungen, Beispielen und Regeln…",
  "skillsMcp.skills.modal.errorNameRequired": "Skill-Name ist erforderlich.",
  "skillsMcp.skills.modal.errorNameInvalid": "Skill-Name darf nur Kleinbuchstaben, Ziffern, Bindestriche und Unterstriche enthalten.",
  "skillsMcp.skills.trash.modalTitle": "Skill-Papierkorb & Wiederherstellung",
  "skillsMcp.skills.trash.modalSubtitle": "Gelöschte Skills werden hier sicher aufbewahrt. Eine Wiederherstellung stellt Symlinks aller Agenten wieder her.",
  "skillsMcp.skills.trash.emptyTitle": "Papierkorb ist leer",
  "skillsMcp.skills.trash.emptyBody": "Keine gelöschten Skills im Papierkorb gefunden.",
  "skillsMcp.skills.trash.colSkill": "Skill-Name",
  "skillsMcp.skills.trash.colDeletedAt": "Gelöscht am",
  "skillsMcp.skills.trash.colOriginalPath": "Ursprünglicher Pfad",
  "skillsMcp.skills.trash.colAction": "Aktion",
  "skillsMcp.skills.trash.restoreBtn": "Wiederherstellen",
  "skillsMcp.skills.trash.restoring": "Wiederherstellen…",
  "skillsMcp.skills.trash.restoreSuccess": "Skill '{name}' wiederhergestellt und Symlinks neu verknüpft.",
  "skillsMcp.mcp.searchPlaceholder": "MCP-Server nach ID, Befehl, Argumenten, Umgebungsvariablen, URL durchsuchen…",
  "skillsMcp.mcp.showSecrets": "Geheimnisse anzeigen",
  "skillsMcp.mcp.maskSecrets": "Geheimnisse maskieren",
  "skillsMcp.mcp.addServerBtn": "MCP-Server hinzufügen",
  "skillsMcp.mcp.emptyFilteredTitle": "Keine MCP-Server entsprechen der Suchanfrage",
  ...
  "skillsMcp.mcp.serverCount": "{count} Server",
  "skillsMcp.mcp.addServerToClient": "Server zu {client} hinzufügen",
  "skillsMcp.mcp.noServersConfigured": "Keine MCP-Server für diesen Client konfiguriert.",
  "skillsMcp.mcp.toggleAria": "Server {id} umschalten",
  "skillsMcp.mcp.scopeProject": "Projekt",
  "skillsMcp.mcp.editBtn": "Server bearbeiten",
  "skillsMcp.mcp.cloneBtn": "Auf anderen Client klonen",
  "skillsMcp.mcp.addSuccess": "MCP-Server '{id}' erfolgreich hinzugefügt.",
  "skillsMcp.mcp.updateSuccess": "MCP-Server '{id}' erfolgreich aktualisiert.",
  "skillsMcp.mcp.deleteSuccess": "MCP-Server '{id}' erfolgreich gelöscht.",
  "skillsMcp.mcp.cloneSuccess": "MCP-Server '{id}' nach {target} geklont.",
  "skillsMcp.mcp.modal.createTitle": "MCP-Server hinzufügen",
  "skillsMcp.mcp.modal.editTitle": "MCP-Server bearbeiten: {id}",
  "skillsMcp.mcp.modal.fieldClient": "Ziel-Client",
  "skillsMcp.mcp.modal.fieldTransport": "Transportprotokoll",
  "skillsMcp.mcp.modal.fieldServerId": "Server-Bezeichner (ID)",
  "skillsMcp.mcp.modal.placeholderServerId": "z.B. memory, sqlite, context7",
  "skillsMcp.mcp.modal.fieldCommand": "Ausführbarer Befehl",
  "skillsMcp.mcp.modal.fieldArgs": "Argumente",
  "skillsMcp.mcp.modal.fieldCwd": "Arbeitsverzeichnis (optional)",
  "skillsMcp.mcp.modal.fieldUrl": "Remote-Server-URL (SSE / HTTP)",
  "skillsMcp.mcp.modal.fieldEnabled": "Server aktiviert",
  "skillsMcp.mcp.modal.envHeader": "Umgebungsvariablen",
  "skillsMcp.mcp.modal.addEnvVar": "Variable hinzufügen",
  "skillsMcp.mcp.modal.envEmptyNote": "Keine Umgebungsvariablen konfiguriert.",
  "skillsMcp.mcp.modal.errorIdRequired": "Server-ID ist erforderlich.",
  "skillsMcp.mcp.modal.errorCommandRequired": "Ausführbarer Befehl ist für stdio-Transport erforderlich.",
  "skillsMcp.mcp.modal.errorUrlRequired": "Remote-Server-URL ist für SSE-Transport erforderlich.",
  "skillsMcp.mcp.clone.modalTitle": "MCP-Server klonen",
  "skillsMcp.mcp.clone.modalSubtitle": "MCP-Server '{id}' von {client} auf einen anderen Client mit automatischer Formatübersetzung kopieren.",
  "skillsMcp.mcp.clone.sourceLabel": "Quell-Server",
  "skillsMcp.mcp.clone.targetClientLabel": "Ziel-Client",
  "skillsMcp.mcp.clone.newIdLabel": "Ziel-Server-ID",
  "skillsMcp.mcp.clone.overwriteLabel": "Zielkonfiguration überschreiben, falls Server-ID bereits existiert",
  "skillsMcp.mcp.clone.cloneBtn": "Server klonen",
  ...
  "subscriptions.agy.title": "Google Antigravity (AGY) Multi-Konto-Matrix",
  "subscriptions.agy.desc": "{count} Google-Konten konfiguriert. Klicken Sie auf 'Als aktiv festlegen', um zu wechseln und mit CLI/IDE zu synchronisieren.",
  "subscriptions.agy.setActive": "Als aktiv festlegen",
  "subscriptions.agy.currentlyActive": "Derzeit aktiv",
  "subscriptions.agy.switching": "Wechseln…",
  "subscriptions.agy.syncPanelTitle": "AGY-Syncstatus (dieser Proxy-Host)",
  "subscriptions.agy.rowProxy": "Aktives Proxy-Konto: {account}",
  "subscriptions.agy.rowCli": "CLI-Anmeldedaten: {status}",
  "subscriptions.agy.rowIde": "IDE-Sync: {status}",
  "subscriptions.agy.status.synced": "synchronisiert",
  "subscriptions.agy.status.pending_restart": "ausstehend — IDE normal beenden, dann erneut versuchen",
  "subscriptions.agy.status.failed": "fehlgeschlagen",
  "subscriptions.agy.status.unsupported": "nicht unterstützt",
  "subscriptions.agy.status.not_installed": "nicht installiert",
  "subscriptions.agy.status.unknown": "unbekannt",
  "subscriptions.agy.retrySync": "Sync für aktuelles Konto erneut versuchen",
  "subscriptions.agy.proxyHostNote": "Sync gilt für die Maschine mit diesem Proxy, nicht unbedingt für die Browser-Maschine. CLI gilt für agy-Prozesse, die nach dem Wechsel gestartet wurden.",
  "subscriptions.agy.nativeKeyringNote": "Hinweis: Unter macOS wird der OS-Schlüsselbundeintrag geschrieben und zurückgelesen; auf anderen Plattformen werden nur die CLI-Dateien synchronisiert.",
  "subscriptions.agy.switchPartial": "{target}-Sync erfordert Aufmerksamkeit: {detail}",
  "subscriptions.agy.switchUnknown": "Wechselergebnis unbekannt: {detail}. Status wurde aktualisiert — Sync-Panel prüfen und ggf. erneut versuchen.",
  "subscriptions.agy.cliOnlyNoIde": "Zu {account} gewechselt. CLI synchronisiert; Antigravity IDE ist auf diesem Host nicht installiert.",
  "subscriptions.agy.noActiveAccount": "keines",

  "subscriptions.agy.quota.gemini": "Gemini",
  "subscriptions.agy.quota.claudeGpt": "Claude / GPT",
  "subscriptions.agy.quota.weekly": "Wöchentlich",
  "subscriptions.agy.quota.fiveHour": "5 Stunden",
  "subscriptions.agy.quota.stale": "Veralteter Cache-Wert",
  "subscriptions.agy.quota.updating": "Kontingent wird aktualisiert…",
  "subscriptions.agy.quota.staleRetry": "Aktualisierung fehlgeschlagen; letzter erfolgreicher Wert. Neuer Versuch in 30 Sekunden.",
  "subscriptions.agy.quota.scopeNote": "Gemeinsame Abonnementlimits je Gruppe: wöchentlich und für 5 Stunden.",
  "subscriptions.agy.quota.unknown": "Quota unbekannt",
  "subscriptions.agy.quota.unavailable": "Quota nicht verfügbar",
  "subscriptions.agy.quota.unavailableHint": "Letzte Abfrage fehlgeschlagen; kein zwischengespeicherter Wert wird als aktuell angezeigt.",
  "subscriptions.agy.quota.remaining": "{pct} % verbleibend",
  "subscriptions.agy.quota.resetUnknown": "Reset unbekannt",
  "subscriptions.agy.quota.observedLabel": "Beobachtet",
  "subscriptions.agy.quota.observedAt": "Beobachtet {time}",
  "subscriptions.agy.quota.observedUnknown": "Beobachtungszeit unbekannt",
  "subscriptions.codex.title": "OpenAI Codex Abonnement & Kontingent",
  "subscriptions.codex.tickets": "Reset-Guthaben: {count} verfügbar",
  "subscriptions.grok.title": "xAI Grok Abonnement & Kontingent",
  "subscriptions.other.title": "Weitere verbundene Abonnements",
  "subscriptions.noAccounts": "Keine angemeldeten Konten für dieses Abonnement gefunden",
  "subscriptions.switchSuccess": "Aktives Konto erfolgreich auf {account} gewechselt",
