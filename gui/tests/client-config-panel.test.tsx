...
test("the API download surface includes DSH, MiniMax Code, Cline, Aside and Raycast as clients", () => {
  expect(CLIENTS).toEqual(["opencode", "pi", "omp", "hermes", "openclaw", "kimi", "gajae", "dsh", "mcode", "zcode", "prime", "cline", "aside", "raycast"]);
  ...
  expect(CLIENT_LABEL_KEYS.cline).toBe("api.clientConfig.clientCline");
