...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@iislee/opencodex"><img src="https://img.shields.io/npm/v/@iislee/opencodex?color=cb3837&label=npm&logo=npm" alt="версия npm"></a>
  <a href="https://github.com/isleei/opencodex/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@iislee/opencodex?color=blue" alt="лицензия"></a>
  <img src="https://img.shields.io/node/v/@iislee/opencodex?logo=node.js&label=node" alt="версия Node">
</p>
...
```
> **О fork.** Этот репозиторий публикует **`@iislee/opencodex`** (npm-пользователь `iislee`).
> Основан на upstream [lidge-jun/opencodex](https://github.com/lidge-jun/opencodex) /
> [`@bitkyc08/opencodex`](https://www.npmjs.com/package/@bitkyc08/opencodex).
> Устанавливайте именно scoped-имя выше. Документация: [opencodex.me](https://opencodex.me/).
...
```bash
npm install -g --allow-scripts=bun @iislee/opencodex   # Node 18+; рантайм Bun подключается автоматически
