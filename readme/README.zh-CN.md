...
<p align="center"><b>面向 OpenAI Codex、Claude Code、Claude Desktop、Grok Build 与 Pi 的通用提供商代理</b><br>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@iislee/opencodex"><img src="https://img.shields.io/npm/v/@iislee/opencodex?color=cb3837&label=npm&logo=npm" alt="npm 版本"></a>
  <a href="https://github.com/isleei/opencodex/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@iislee/opencodex?color=blue" alt="许可证"></a>
  <img src="https://img.shields.io/node/v/@iislee/opencodex?logo=node.js&label=node" alt="Node 版本">
</p>
...
```bash
npm install -g --allow-scripts=bun @iislee/opencodex   # Node 18+；Bun 运行时会自动捆绑
